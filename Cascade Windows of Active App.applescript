...
property snapToEdgeApps : {"Console", "Activity Monitor", "Dictionary", "Address Book", "TextEdit", "HelpViewer", "Keychain Access", "Disk Utility", "Contacts", "TestFlight", "Notes", "Font Book", "Dash", "Terminal", "Creative Cloud", "Finder", "App Store", "Erinnerungen", "ClamXAV", "Teams", "Microsoft Teams (work or school)", "MSTeams", "Facetime", "Microsoft AutoUpdate"}
-- Apps whose windows should be centered
property centeredApps : {}
...
on run
	...
	tell application "System Events"
		...
		set visibleProcesses to application processes whose frontmost is true and name does not start with "Adobe"
...
-- 
-- Kommerziell ist eine Nutzung dann, wenn sie in erster Linie auf kommerziell relevante Vorteile oder auf eine Vergü﻿tung abzielt.
-- 
