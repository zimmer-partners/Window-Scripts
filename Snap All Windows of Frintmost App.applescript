...
on run
	...
	tell application "System Events"
		...
		set visibleProcesses to application processes whose visible is true and frontmost is true and name does not start with "Adobe"
		
		-- Loop apps
		repeat with xProcess in visibleProcesses
			if name of xProcess is not in excludeApps then
				if name of xProcess is in maxHeightApps then
